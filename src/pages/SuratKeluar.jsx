...
export default function SuratKeluar() {
  ...
  const [formData, setFormData] = useState({
    nomorSurat: '',
    pengirim: 'Sekretariat Fakultas', // Default sender for outgoing letters
    perihal: '',
    isi: '',
    tglSurat: new Date().toISOString().split('T')[0],
    lampiran: 'dokumen_keluar.pdf',
  });

  const loadLetters = async () => {
    setLoading(true);
    try {
      const response = await suratService.getKeluar(currentPage, limit);
      ...
      console.warn('Failed to load outgoing letters from API. Using fallback mock data.');
      // Use fallback mock data for outgoing letters
      const mockData = [
        {
          id: 1,
          nomorSurat: '0012/FT-M/III/2026',
          pengirim: 'Dekanat Fakultas Teknik',
          perihal: 'Surat Keterangan Aktif Kuliah',
          isi: 'Surat keterangan aktif kuliah untuk keperluan pengajuan beasiswa mahasiswa berprestasi nasional.',
          tanggal: '2026-05-22',
          tglSurat: '2026-05-22',
          status: 'Disetujui',
          lampiran: 'suket_aktif_kuliah.pdf',
        },
        {
          id: 2,
          nomorSurat: '0223/UN10/KM/2026',
          pengirim: 'Himpunan Mahasiswa Teknik',
          perihal: 'Permohonan Peminjaman Aula Kampus',
          isi: 'Surat permohonan peminjaman Aula Gedung A lantai 2 untuk pelaksanaan seminar nasional kewirausahaan pemuda.',
          tanggal: '2026-05-19',
          tglSurat: '2026-05-19',
          status: 'Pending',
          lampiran: 'proposal_aula.pdf',
        },
        {
          id: 3,
          nomorSurat: '0151/FT/PL/V/2026',
          pengirim: 'Fakultas Teknik',
          perihal: 'Surat Tugas Pendamping Lomba Robotika',
          isi: 'Surat tugas dosen pendamping untuk mengawal delegasi mahasiswa dalam kompetisi robotika nasional di Surabaya.',
          tanggal: '2026-05-10',
          tglSurat: '2026-05-10',
          status: 'Disetujui',
          lampiran: 'surat_tugas_robotika.pdf',
        },
      ];
      setLetters(mockData);
      setTotalPages(1);
  ...
  const handleCreate = async (e) => {
    ...
    try {
      await suratService.createSurat({
        ...formData,
        // We can flag this as an outgoing letter, e.g. type: 'keluar' if backend requires,
        // but standard format uses the same POST /surat endpoint
      });
      
      Swal.fire({
        title: 'Berhasil!',
        text: 'Surat keluar berhasil dikirim/ditambahkan.',
        icon: 'success',
      ...
      // Direct mock update if API is down
      const newLetter = {
        id: Date.now(),
        ...formData,
      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-4">
          <div>
            ...
            <p className="text-gray-600 mt-1">Kelola dan lacak surat keluar yang dikirimkan oleh unit Anda</p>
          </div>
              ...
              <form onSubmit={handleCreate} className="space-y-4">
                <div>
                  ...
                  <input
                    type="text"
                    required
                    placeholder="Contoh: 002/UN10/AK/2026"
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm font-semibold text-gray-700 mb-1">Pengirim / Pengaju</label>
                    <input
                      type="text"
                      required
                ...
                <div>
                  ...
                  <input
                    type="text"
                    required
                    placeholder="Perihal/Judul surat keluar"
                ...
                <div>
                  <label className="block text-sm font-semibold text-gray-700 mb-1">Isi Ringkas Surat</label>
                  <textarea
                    rows={4}
                    required
                    placeholder="Tuliskan permohonan atau isi surat..."
                    value={formData.isi}
                ...
                <div>
                  ...
                  <input
                    type="text"
                    placeholder="dokumen_lampiran.pdf"
              ...
              <div className="space-y-4">
                <div className="p-4 bg-gray-50 rounded-xl space-y-3">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-xs text-gray-500 font-bold">Pengirim / Pengaju</p>
