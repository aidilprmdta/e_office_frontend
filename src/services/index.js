...
export const suratService = {
  getMasuk: (page = 1, limit = 10) =>
    apiClient.get(`/surat/masuk?page=${page}&limit=${limit}`),
  getKeluar: (page = 1, limit = 10) =>
    apiClient.get(`/surat/keluar?page=${page}&limit=${limit}`),
  ...
  rejectSurat: (id, reason) =>
    apiClient.post(`/surat/${id}/reject`, { reason }),
};

export const tugasAkhirService = {
  getList: (page = 1, limit = 10) =>
    apiClient.get(`/tugas-akhir?page=${page}&limit=${limit}`),
  ...
  approveProposal: (id) =>
    apiClient.post(`/tugas-akhir/${id}/approve-proposal`),
};
